...
export const Intro = () => {
  ...
  return (
    ...
    >
      ...
      >
        A software engineer based in India. I&#39;m passionate about building
        modern web applications using React, Next.js, TypeScript, and Node.js.
      </motion.p>
      <motion.div
        initial={{ opacity: 0, y: 100 }}
        animate={{ opacity: 1, y: 0 }}
      ...
      >
        ...
        <Button variant="outline" size="lg" className="hidden sm:flex" asChild>
          <a href="/atul-patel-resume.pdf" download>
            Download CV <Icons.download className="ml-2 size-4" />
          </a>
        </Button>
        <Button variant="outline" size="icon" asChild>
          <Link
            href="https://linkedin.com/in/atulpat3l"
            aria-label="Linkedin"
            target="_blank"
          >
        ...
        <Button variant="outline" size="icon" asChild>
          <Link
            href="https://github.com/atulpat3l"
            aria-label="Github"
            target="_blank"
          >
